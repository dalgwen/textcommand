...
public class HttpServerTest {
    ...
    public void testHttp() throws Exception {
        CommandExecutor commandExecutor = TestUtils.prepareCommandExecutor(EchoCommands.class);

        JettyServer jettyServer = new JettyServer(commandExecutor, TextCommandParameters.DEFAULT_HTTP_PORT);
        jettyServer.start();
        int tried = 0;
